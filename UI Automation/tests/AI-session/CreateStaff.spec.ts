...
test.describe('User Management Tests', () => {
  test('Login and Navigate to Users tab in Settings Menu', async ({ page }) => {
    ...
    // 1. First name: Sanu
    await page.fill('input[name="firstName"]', 'Avi');
    
    // 2. Last name: Bhor
    await page.fill('input[name="lastName"]', 'yadhav');
    ...
    await page.fill('input[name="emailId"]', 'avi.yadhav+39@thinkitive.com');
    ...
    const userRow = page.locator('tr:has-text("Avi yadhav")');
    await expect(userRow.locator('text=Invited')).toBeVisible();
    
    console.log('✅ Test completed successfully!');
    console.log('📧 User created: Avi yadhav (avi.yadhav+39@thinkitive.com)');
...
test.describe('User Management Tests - Extended', () => {
  test('Login and Create User with Enhanced Verification', async ({ page }) => {
    ...
    const testData = {
      ...
      userEmail: 'avi.yadhav+39@thinkitive.com',
